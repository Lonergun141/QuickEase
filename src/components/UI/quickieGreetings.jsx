...
export const QuickieGreetings = () => {
  ...
  return (
    <div
      ...
      } flex flex-col md:flex-row items-center justify-center bg-white quickie-greetings dark:bg-darken text-black rounded-xl p-6 mb-8 overflow-hidden relative shadow-md transform transition-all duration-700 ease-in-out`}>
      ...
      <img
        ...
        className="w-full md:w-1/4 mb-4 md:mb-0 md:mr-6 transform hover:scale-105 transition-all duration-300 ease-in-out animate-float z-5"
      />

      {/* Greeting Text */}
      <div className="text-center md:text-left">
        <h2 className="text-xl sm:text-2xl md:text-3xl font-semibold mb-2 text-highlights dark:text-secondary">
          Hello, {userInfo?.firstname || 'Learner'}!
        </h2>
        <p className="text-base sm:text-md md:text-xl font-normal dark:text-secondary">
          I'm{' '}
