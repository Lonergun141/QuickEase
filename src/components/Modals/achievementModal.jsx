	...
	return (
		<Modal isOpen={true} onClose={onClose}>
			<div className="flex flex-col items-center justify-center p-4 bg-white dark:bg-darken  rounded-lg  transition duration-300 ease-in-out">
				...
				<h1 className="text-lg font-pbold text-center mt-2 text-dark dark:text-secondary">
					{achievement.title}
				</h1>
				<p className="text-center mt-2 text-dark dark:text-secondary font-pregular">
