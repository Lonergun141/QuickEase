				...
				{isEditing ? (
					<div className="space-y-6">
						...
						<Modal
							...
							{/* Body */}
							<div className="mt-4">
								<p className="text-gray-600 dark:text-secondary text-sm font-pregular">
									Are you sure you want to delete all flashcards for this note? This action
									cannot be undone.
								</p>
							</div>
							...
							<div className="flex justify-end items-center mt-6 space-x-3">
								...
								<p
									...
									className="px-8 py-2 text-gray-700 dark:text-gray-200 cursor-pointer hover:bg-gray-400 hover:opacity-80 rounded-md transition ease-in-out">
									Cancel
								</p>
								...
								<p
									...
									className="px-4 cursor-pointer py-2 bg-red-600 text-white rounded-md hover:bg-red-700 hover:opacity-80 transition ease-in-out">
									Delete All
								</p>
							</div>
						</Modal>
						...
						<div className="mt-10">
							...
							<div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
								{cards.map((card, index) => (
									<div
										key={card.id}
										className="p-4 rounded-xl bg-white dark:bg-darken cursor-pointer hover:scale-110 transform transition-transform duration-200 ease-out hover:bg-gray-100 dark:hover:bg-darkS shadow-md hover:shadow-xl"
